  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Catequesis - Nivel 3</Text>
        <Text style={styles.subtitle}>Sacramento de la Confirmación</Text>
      </View>
      ...
      <View>
        <View style={styles.requisitoRow}>
          <Text style={styles.requisitoText}>1 fotocopia del certificado de la Primera Comunión </Text>
...
export default Sacramento_Confimacion;
